...
public class TotalNumOfLettersGenericUDAF extends AbstractGenericUDAFResolver {
    ...
    public GenericUDAFEvaluator getEvaluator(TypeInfo[] parameters)
        ...
        if (parameters.length != 1) {
        	//just only one parameter be expected
        ...
        //The Category of parameter should be PRIMITIVE
        ...
        //cast ObjectInspector to PrimitiveObjectInspector
        PrimitiveObjectInspector inputOI = (PrimitiveObjectInspector) oi;
        //The Category of parameter(PrimitiveObjectInspector) should be String
